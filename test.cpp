...
void testAddition() {
    ...
    assert(result.toString(0) == "832616727367126732168110555682340281645957633738919221");  

    LongNumber c("-8829415895002903528051847651578957689"); 
    LongNumber d("987654321");   
    LongNumber result2 = d + c;
    assert(result2.toString(0) == "-8829415895002903528051847650591303368"); 
...
void testSubtraction() {
    ...
    LongNumber result3 = e - f;
    assert(result3.toString(0) == "761347965084343701378012657238154067741073872798964322824280530665707930196289056904806335381929800997361");  
    std::cout << "OK\n";
...
void testDivision() {
    ...
    assert(result.toString(0) == "3003003003003003003003003");  
